...
namespace FastReport.Design.StandardDesigner
{
  ...
  public class DesignerMenu : Bar, IDesignerPlugin
  {
    ...
    private void UpdateControls()
    {
      ...
      miData.Visible = Designer.cmdData.Enabled;
#if Basic
    ...
    public DesignerMenu(Designer designer) : base()
    {
      ...
      miDataChoose = CreateMenuItem(Designer.cmdData.InvokeReportData);
      miDataAdd = CreateMenuItem(Res.GetImage(137), Designer.cmdData.InvokeAddDataSource);
