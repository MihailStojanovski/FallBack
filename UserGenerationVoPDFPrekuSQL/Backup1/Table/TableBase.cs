...
namespace FastReport.Table
{
  ...
  public class TableBase : BreakableComponent, IParent
  {
    ...
    {
      if (FLockCorrectSpans || IsResultTable || (correct == 1 && rowIndex >= Rows.Count))
        return;
    ...
    {
      if (FLockCorrectSpans || IsResultTable || (correct == 1 && columnIndex >= Columns.Count))
        return;
