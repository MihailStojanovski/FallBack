  ...
  internal class SplitPrintController : PrintControllerBase
  {
    ...
    { 
      ...
      while (true)
      {
        ...
        if (Page == null) 
          break;
        SplitPage(Page.PaperWidth, Page.PaperHeight, FSheetWidth, FSheetHeight,
        ...
        float pieceX = landscape ? FSheetHeight : FSheetWidth;
        float pieceY = landscape ? FSheetWidth : FSheetHeight;
