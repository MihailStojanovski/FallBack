...
namespace FastReport.Code
{
  internal class VbCodeHelper : CodeHelperBase
  {
    ...
    {
      return scriptText.Replace("Class ReportScript", "Class " + className + "\r\n    Inherits Report").Replace(
        "Private Function CalcExpression", "Protected Overrides Function CalcExpression");
    }
    ...
    public override string GetMethodSignatureAndBody(MethodInfo info)
    {
      ...
      foreach (System.Reflection.ParameterInfo par in pars)
      {
        ...
        result += GetEquivalentKeyword(par.ParameterType.FullName) + ", ";
      }
      ...
      result += " As " + info.ReturnType.FullName;
      result += "\r\n";
