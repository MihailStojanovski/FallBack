...
namespace FastReport.Design.ToolWindows
{
  ...
  public class DictionaryWindow : ToolWindowBase
  {
    ...
    private void UpdateTree()
    {
      ...
      if (FReport != null)
      {
        ...
        if (canShowData)
        {
          ...
          DataHelper.CreateDataTree(FReport.Dictionary, rootNode.Nodes, true, true, true, true);
        }
        ...
        rootNode.SelectedImageIndex = rootNode.ImageIndex;
        DataHelper.CreateVariablesTree(FReport.Dictionary.SystemVariables, rootNode.Nodes);
        ...
        rootNode.SelectedImageIndex = rootNode.ImageIndex;
        DataHelper.CreateTotalsTree(FReport.Dictionary.Totals, rootNode.Nodes);
        ...
        rootNode.SelectedImageIndex = rootNode.ImageIndex;
        DataHelper.CreateParametersTree(FReport.Dictionary.Parameters, rootNode.Nodes);

        // functions
        rootNode = buffer.Nodes.Add(Res.Get("Designer,ToolWindow,Dictionary,Functions"));
        rootNode.ImageIndex = 52;
        rootNode.SelectedImageIndex = rootNode.ImageIndex;
        DataHelper.CreateFunctionsTree(FReport, rootNode.Nodes);
      }
    ...
    private void btnActions_PopupOpen(object sender, PopupOpenEventArgs e)
    {
      ...
      miNew.Enabled = Designer.cmdData.Enabled;
      miOpen.Enabled = Designer.cmdData.Enabled;
      miMerge.Enabled = Designer.cmdData.Enabled;
      miSave.Enabled = Designer.cmdData.Enabled;
      miChooseData.Enabled = Designer.cmdData.Enabled;
      miNewDataSource.Enabled = Designer.cmdData.Enabled;
      miNewRelation.Enabled = Designer.cmdData.Enabled;
      miNewParameter.Enabled = Designer.cmdData.Enabled;
      miNewTotal.Enabled = Designer.cmdData.Enabled;
      miNewCalculatedColumn.Enabled = Designer.cmdData.Enabled && CanCreateCalculatedColumn;
    }

    private void mnuContextRoot_PopupOpen(object sender, PopupOpenEventArgs e)
    {
      mnuContextRoot.SubItems.Clear();
      if (!Designer.cmdData.Enabled)
      {
        e.Cancel = true;
        return;
      }
    ...
    public DictionaryWindow(Designer designer) : base(designer)
    {
      ...
      miChooseData = AddButton(null, Designer.cmdData.InvokeReportData);
      miChooseData.BeginGroup = true;

      miNewDataSource = AddButton(Res.GetImage(137), Designer.cmdData.InvokeAddDataSource);
      ...
      miEdit = AddButton(Res.GetImage(69), miEdit_Click);
