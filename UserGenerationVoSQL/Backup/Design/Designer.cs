...
namespace FastReport.Design
{
  ...
  /// </remarks>
  [ToolboxItem(false), Designer(typeof(LayoutDesigner))]
  public partial class Designer : UserControl, ISupportInitialize
  {
    ...
    /// <summary>
    /// The commands under the "Data" menu.
    /// </summary>
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public DataCommand cmdData
    {
      get { return FcmdData; }
    }
    ...
    internal event EventHandler LayoutChangedEvent;
    ...
    public bool CreateEmptyReport()
    {
      ...
      if (result)
      {
        Config.DesignerSettings.OnReportLoaded(this, new ReportLoadedEventArgs(ActiveReportTab.Report));
        ActiveReportTab.SetModified();
        UpdatePlugins(null);
      }
  ...
  internal class LayoutDesigner : ParentControlDesigner
  {
