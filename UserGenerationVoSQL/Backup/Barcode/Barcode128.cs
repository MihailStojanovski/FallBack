...
namespace FastReport.Barcode
{
  ...
  public class Barcode128 : LinearBarcodeBase
  {
    ...
    internal override void DrawText(Graphics g, string data)
    {
      data = StripControlCodes(data, true);
      base.DrawText(g, data);
    }
    ...
    internal override string GetPattern()
    {
      ...
      switch (nextChar)
      {
        ...
        default:
          throw new Exception("Barcode must start with '&A;', '&B;' or '&C;' sequences");
      }
      ...
      while (index < code.Length)
      {
        ...
        if (idx < 0)
          throw new Exception("Invalid character in input code");
